// Expand your banking system with specific exception types for different error scenarios.
...
int main() {
    try {
        ...
        processWithdrawal(500.0, 300.0, 1000.0, 200.0); // Should throw InsufficientFundsException        
        ...
        std::cout << "Banking error: " << e.what() << " (Code: " << e.getErrorCode() << ")" << std::endl;        
...
/*🔍 Practice
Test the withdrawal function with different parameter combinations to trigger each exception type.
Add error codes to distinguish between different error categories programmatically.
Implement a transfer function that can throw multiple types of exceptions.
Create catch blocks that handle exceptions at different levels of specificity.

✅ Success Checklist
    Exception hierarchy properly implements inheritance relationships
    Each exception type provides specific, contextual error information
    Error codes enable programmatic error handling
    Catch blocks are ordered from most specific to most general*/